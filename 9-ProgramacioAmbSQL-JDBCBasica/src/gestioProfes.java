...
public class gestioProfes
   ...
   public static void main (String args[])
	...
	try
       ...
       ResultSet res = null;
       PreparedStatement ps = c.prepareStatement("select dni, nomProf from professors p where p.telefon < '" + buscaTelf + "'");
       res = ps.executeQuery();
       ...
       if (res.equals(null)) {
           ...
           while (fi)
           {
        	  System.out.println(res.getString("dni") + " " + res.getString("nomProf"));
        	  fi = res.next();
           }
       }
